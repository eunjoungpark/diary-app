    ...
    <section class="login-container">
        <div class="login-bx">
            <fieldset>
                ...
                <div class="input-bx"><el-input placeholder="이메일 주소입력" id="user-email" v-model="email" @input="userLogin()"></el-input><label class="skip" for="user-email">email</label></div>
                ...
                <div class="input-bx"><el-input placeholder="비밀번호" id="user-password" v-model="password"></el-input><label class="skip" for="user-password">password</label></div>
                <div class="input-bx"><el-input placeholder="비밀번호 재입력" id="user-repassword" v-model="password"></el-input><label class="skip" for="user-repassword">password</label></div>
                <el-alert title="메일 형식이 아닙니다." type="error" v-if="!$v.email.email"></el-alert>
                ...
                <div class="etc-bx"><router-link to="/login">← Login</router-link></div>
                {{$v.password}}
            </fieldset>
        </div>
    </section>
